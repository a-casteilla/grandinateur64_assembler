...
/* Converts a string to a number. I have added this function because strtoul
 * lacks some features in term of base recognition. I want to have a '$' as a
 * valid prefix for a hex value and "%" to be a valid binary prefix. */
...
/* This function converts escaped character in strings to their raw form. */
